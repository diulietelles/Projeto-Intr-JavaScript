...
// Função para buscar doadores por ultima data de doacao
function buscarPorDataUltimaDoacao() {
    ...
    for (let i = 0; i < doadores.length; i++) {
        ...
        // Verifiquei se a data da última doação corresponde à data desejada//
...
while (continuar) {
    ...
    pergunta += "3. Buscar doador por tipo sanguineo\n";
    pergunta += "4. Buscar doador por data da ultima doacao\n";
    pergunta += "5. Sair\n";
